...
$query = "
    SELECT mr.id, mt.name as program, mt.parent_id,
           ...
           COALESCE(mr.contact_no, u.phone) as contact_no, mr.created_at, mr.status,
           b.name as barangay, mr.is_walkin,
        ...
        <div class="dashboard-container">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="mb-0">View and manage all MSWD requests</p>
                </div>
...
<div class="filter-group">
    ...
    <select class="form-select" id="statusFilter">
        ...
        <?php foreach ($statuses as $status): ?>
            <option value="<?= $status ?>">
                <?= 
                    $status === 'mswd_approved' ? 'MSWD Approved' : 
        ...
        <div id="resultsContainer">
            <?php if ($result->num_rows == 0): ?>
                <div class="no-requests">
                    ...
                    <p>There are no MSWD requests to display.</p>
                </div>
            <?php else: ?>
