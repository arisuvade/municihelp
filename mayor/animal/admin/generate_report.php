...
// Get admin info
$adminId = $_SESSION['animal_admin_id'];
...
function getReportData($postData, $adminId) {
    ...
    // Base query for all programs - filtered by actions performed by the current admin
    $query = "SELECT 
              ...
              WHERE (rr.verifiedby_admin_id = ? OR 
                    rr.cancelledby_admin_id = ?)
    ...
    $params = [
        ...
        $adminId, $adminId, $adminId, $adminId, $startDate, $endDate,
        $adminId, $adminId, $startDate, $endDate
    ];
