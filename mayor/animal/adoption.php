    ...
    <div class="dashboard-header">
        <div class="dashboard-container">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="mb-1">Dog Adoption</h1>
                    <p class="mb-0">Give a rescued dog a loving home</p>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="dog-card card">
                                    ...
                                    <div class="dog-card-footer">
                                        ...
                                        <?php if ($status === 'adopted'): ?>
                                            <button class="btn btn-adopt" disabled style="opacity: 0.7; cursor: not-allowed;">
                                        ...
                                        <?php else: ?>
                                            ...
                                            <?php else: ?>
                                                <a href="adoption_form.php?dog_id=<?= $dog['id'] ?>" class="btn btn-adopt">
