...
<body>
    <div class="dashboard-header">
        <div class="dashboard-container">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="mb-1">Vice Mayor's Office Admin Management</h1>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="adminForm">
                        ...
                        <input type="hidden" id="adminDepartment" value="8">
                        <div class="mb-3">
    ...
    <div class="modal fade" id="successDeleteModal" tabindex="-1, initial-scale=1.0">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-success text-white">
...
$(document).ready(function() {
    ...
    $('#saveAdminBtn').click(function() {
        ...
        const departmentId = 8; // Always set to department ID 8
    ...
    function applyFilters() {
        ...
        if (!anyVisible && (searchTerm || dateFilter)) {
            noResultsMsg.show();
        } else {
            noResultsMsg.hide();
        }
